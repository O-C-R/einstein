// 
// randomVersion to output splines
void viewKeywords3(ArrayList<Article> articlesIn, ArrayList<Wikipedia> wikisIn) {
  ...
  float yCenter = pg.height / 2;
  float spineHeight = pg.height - 200;
