...
color colorAuthorMin = #e9bf1b;//#5123bf;//#292a4f;//#6b03ff; //#eaa200;//#00aa00; // #6E99DE; //#005555; // #6bc1b0;  // #eaa200; // or #ef847f fill color for the minimum number of authors metric
color colorAuthorMax = #e81f1f;//#e81f58;//#ea4f1c;//#ff5003;//#eaa200;//#ea4f1c;//#FFD736; //#9375F7; // #00ffff; //#e3903a; // #fce579; // or #93cb9a fill color for the max number of authors metric
...
color colorConnectorLine = #ea4f1c;//#d9f7ad;//#ea4f1c; // curves from Article to term


// line from term down
color colorTermToGround = color(50, 200, 102); // the line from the term down to the base of the z
color colorTermNetwork = #00cddd;//color(0, 255, 0); // color of the network below the terms 
...
// published stuff
color colorPublished = #00cddd;//#FFD736; //#9895FF; //#fe31f2;
color colorUnpublished = #075aad;//#292a4f;//#235866;//#D8C267; //#908EC4; //#770077;// #2672f9; // #2eb5ab;
